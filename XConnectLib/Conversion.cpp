...
float KgToLbs(float kg) { return kg / 0.45359237f; }
...
float MetersToKnot(float meters) { return meters * 1.9438444924406f; }
...
float LbsToKg(float lbs) { return lbs * 0.45359237f; }
